...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
    ...
    endpoints.addEndpoint("1", "agitador.s1", endpointType.genericSensor).variableTypeId = 1021;
    endpoints.addEndpoint("2", "agitador.s2", endpointType.genericSensor).variableTypeId = 1021;
    endpoints.addEndpoint("3", "agitador.s3", endpointType.genericSensor).variableTypeId = 1021;
    endpoints.addEndpoint("4", "agitador.s7", endpointType.genericSensor).variableTypeId = 1021;
    endpoints.addEndpoint("5", "agitador.s9", endpointType.genericSensor).variableTypeId = 1021;
